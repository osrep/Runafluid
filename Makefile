...
all: libRunafluid.a libDistInit.a test/libEfieldEdit.a test/libTeEdit.a test/libNeEdit.a test/libTeEdit.a test/libTimeback.a test/libTempInit.a
...
test/libTempInit.a: test/tempinit.o
	ar -rvs $@ $^	
