...
!-------------------------------------------------------!
  ...
  SUBROUTINE FC2K_EXPDECAY    (COREPROF, EQUILIBRIUM, CORESOURCE, code_parameters) 
...
! +++ CPO derived types:
      ...
      CALL EXPDECAY    (COREPROF, EQUILIBRIUM, CORESOURCE, code_parameters)
      

      RETURN


      END SUBROUTINE FC2K_EXPDECAY  
