...
!-------------------------------------------------------!
  ...
  SUBROUTINE EXPDECAY    (COREPROF, EQUILIBRIUM, CORESOURCE, code_parameters) 
...
! +++ ADD IDENTIFIER TO OUTPUT CPO VALUES(1):
    ...
    CORESOURCE(1)%VALUES(1)%sourceid%id          = 'expdecay'
    CORESOURCE(1)%VALUES(1)%sourceid%flag        = 34
    CORESOURCE(1)%VALUES(1)%sourceid%description = 'Exponential heat drain'
...
! +++ Ambipolarity check:
     ...
     IF (STOT_EL.NE.SUM(STOT*ZION))THEN
        WRITE(*,*)'=================================='
        WRITE(*,*)'=================================='
        WRITE(*,*)'== Your Expdecay sources are    =='
        WRITE(*,*)'== not ambipolar!               =='
